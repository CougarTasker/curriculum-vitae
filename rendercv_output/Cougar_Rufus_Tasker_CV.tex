...
\usepackage[
    pdftitle={Cougar Rufus Tasker's CV},
    pdfauthor={Cougar Rufus Tasker},
...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Cougar Rufus Tasker - Page \thepage{} of \pageref*{LastPage}}
...
\begin{document}
    ...
    \begin{header}
        \textbf{\fontsize{24 pt}{24 pt}\selectfont Cougar Rufus Tasker}

        \vspace{0.3 cm}

        \normalsize
        \mbox{{\color{black}\footnotesize\faMapMarker*}\hspace*{0.13cm}London, UK}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+44-7597-029304}{\color{black}{\footnotesize\faPhone*}\hspace*{0.13cm}+44 7597 029304}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Achieved First-Class Honours; 91\% final year average.
                \item Thesis on Reinforcement Learning: \href{https://github.com/CougarTasker/reinforcement-learning-msci-project/blob/main/reports/Final/Final_Report.pdf}{Effective Exploration in Markov Decision Processes}
                \item Developed a robust Java calculator adhering to software engineering principles.
                \item Collaborated on a restaurant management system, Achieving a perfect 100\% Grade.
            \end{highlights}
        \end{onecolentry}
